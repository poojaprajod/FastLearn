...
public class add_student_view extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      out.println("<form action='add_student.do' method='POST'>");
         out.println("Student ID (5 character): <input type='text' name='student_id' /><br />");
