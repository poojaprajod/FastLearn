...
public class edit_student_view extends HttpServlet {
      ...
      ex = pst.executeQuery();
        ...
        try {
            ...
            out.println("<li>"+msg+"</li");
             ...
             out.println("</ul>");}
            out.println("<h3> SELECT STUDENT TO BE EDITED </h3>");
            out.println("<form action='edit_student.do' method='POST'>");
            out.println("<select name='id'>");
            while(ex.next()){
                String val=ex.getString("student_id")+"  "+ex.getString("first_name")+"  "+ex.getString("last_name");
            out.println("<option value="+ex.getString("student_id") +">"+val+"</option>");
            }
            out.println("</select>");
            ...
            out.println("<option value = 'faculty_id' >FACULTY</option>");
