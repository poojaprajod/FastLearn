   ...
   final String PASS = "toor";  
     ...
     try{
      ...
      ex = pst.executeQuery();
            ...
            <html>
            <body>
                <h2 style="text-align: center;background-color:lightskyblue;color: brown">EDIT FACULTY </h2>
       <%   List errors=(LinkedList) request.getAttribute("errors"); 
           ...
           <%}%>
            ...
            <% } %>
           <p style="color: green;text-align: center"> SELECT FACULTY TO BE EDITED </h3>
           <form action='edit_faculty.do' method='POST' style="font-size: larger;font-style: italic;text-align: center">
           <select name='id'>
          <%while(ex.next()){
