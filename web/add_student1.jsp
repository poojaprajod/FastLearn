...
<html>
    <body>
        <h2 style="text-align: center;color: brown;background-color: lightskyblue">ADD STUDENT DETAILS</h2>
           <br/>
           <hr/>
           <br/>
...
<p style='color:green;text-align:center'>Enter details of student to be added</p>
  <form action='add_student.do' method='POST' style="text-align: center;font-size: larger;font-style: italic">
   Student ID (5 character): <input type='text' name='student_id' /><br /><br/>
